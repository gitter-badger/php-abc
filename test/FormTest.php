...
class FormTest extends PHPUnit_Framework_TestCase
{
  ...
  public function testMergeValues()
  {
    ...
    $list = $xpath->query( "/form/fieldset/div/input[@name='name[options][1]' and @checked='checked']" );
    $this->assertEquals( 1, $list->length );

    // name[options][2] must be changed.
    $list = $xpath->query( "/form/fieldset/div/input[@name='name[options][2]' and @checked='checked']" );
    $this->assertEquals( 1, $list->length );

    // name[options][3] must be changed.
    $list = $xpath->query( "/form/fieldset/div/input[@name='name[options][3]' and not(@checked)]" );
    $this->assertEquals( 1, $list->length );
  }
