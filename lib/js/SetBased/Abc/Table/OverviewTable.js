...
//----------------------------------------------------------------------------------------------------------------------
require(['SetBased/Abc/Table/OverviewTable/ColumnTypeHandler/DateTime']);
require(['SetBased/Abc/Table/OverviewTable/ColumnTypeHandler/Ipv4']);
require(['SetBased/Abc/Table/OverviewTable/ColumnTypeHandler/None']);
require(['SetBased/Abc/Table/OverviewTable/ColumnTypeHandler/Numeric']);
require(['SetBased/Abc/Table/OverviewTable/ColumnTypeHandler/Text']);
require(['SetBased/Abc/Table/OverviewTable/ColumnTypeHandler/Uuid']);
